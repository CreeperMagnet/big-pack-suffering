...
execute if entity @s[predicate=!tcc:entity/holding/mending_item,tag=tcc.mending_repaired] run function tcc:item/item_modification/durability/mend_items/reset
...
execute if entity @s[predicate=tcc:entity/wearing/dragon_head] if entity @e[type=end_crystal,distance=..40,nbt=!{ShowBottom:1b},tag=!global.ignore] at @s run function tcc:entity/end_crystal/heal
