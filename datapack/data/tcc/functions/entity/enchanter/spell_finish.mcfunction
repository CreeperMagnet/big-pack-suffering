...
execute as @e[sort=random,distance=..10,team=global.antivil,tag=!tcc.enchanter,tag=!tcc.snail,predicate=tcc:entity/global.ignore,limit=1,nbt=!{ActiveEffects:[{Ambient:1b}]}] at @s run function tcc:entity/enchanter/enchanted
