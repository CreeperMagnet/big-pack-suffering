...
execute if entity @s[tag=!tcc.trader_entity.still,predicate=!tcc:entity/moving] run data modify entity @s HandItems[0] set from entity @s ArmorItems[3].tag.tcc.storage.model_items[0]
execute if entity @s[tag=!tcc.trader_entity.still,predicate=tcc:entity/moving,tag=!tcc.no_ai] run data modify entity @s HandItems[0] set from entity @s ArmorItems[3].tag.tcc.storage.model_items[1]
