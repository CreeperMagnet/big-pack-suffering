...
execute if block ~ ~ ~ #minecraft:beehives if entity @s[predicate=!tcc:entity/sneaking] run function tcc:item/wrench/rotate/block_tag/block_entities/beehives
execute if block ~ ~ ~ #minecraft:beehives if entity @s[predicate=tcc:entity/sneaking] run function tcc:item/wrench/rotate/block_tag/block_entities/beehives_info
