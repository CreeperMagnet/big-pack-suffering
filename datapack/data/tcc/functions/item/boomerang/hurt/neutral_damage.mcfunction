...
execute if entity @s[type=minecraft:polar_bear,predicate=!tcc:entity/baby] run function tcc:item/boomerang/hurt/aggro
execute if entity @s[type=minecraft:polar_bear,predicate=tcc:entity/baby] as @e[type=minecraft:polar_bear,predicate=!tcc:entity/baby,distance=..41,tag=!global.ignore] run function tcc:item/boomerang/hurt/aggro
