...
execute if entity @s[predicate=tcc:entity/full_inventory] run loot spawn ~ ~ ~ loot tcc:items/complete_healer_quest_book
loot give @s[predicate=!tcc:entity/full_inventory] loot tcc:items/complete_healer_quest_book
