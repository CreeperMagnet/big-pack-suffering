...
# Fortune
scoreboard players reset @s tcc.dummy
execute unless entity @s[tag=tcc.snipper] store result score @s tcc.dummy run data get entity @e[type=item,predicate=tcc:block/block_breakers/accepted_enchanted_book,limit=1,dz=0,dx=0,dy=0,sort=nearest,tag=!global.ignore] Item.tag.StoredEnchantments[{id:"minecraft:fortune"}].lvl
...
scoreboard players reset @s tcc.dummy
scoreboard players reset @s tcc.dummy2
execute store result score @s tcc.dummy run data get entity @e[type=item,predicate=tcc:block/block_breakers/accepted_enchanted_book,limit=1,dz=0,dx=0,dy=0,sort=nearest,tag=!global.ignore] Item.tag.StoredEnchantments[{id:"minecraft:efficiency"}].lvl
...
execute if entity @s[scores={tcc.dummy=1..}] run kill @e[type=item,predicate=tcc:block/block_breakers/accepted_enchanted_book,limit=1,dz=0,dx=0,dy=0,sort=nearest,tag=!global.ignore,tag=!global.ignore.kill]
