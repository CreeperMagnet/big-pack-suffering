############################################################
# Gobblerift hurt sound and other effects
############################################################
...
execute if entity @p[advancements={tcc:technical/block/gobblerift/hurt=true},predicate=tcc:entity/holding/gobblerift_instamine] run function tcc:block/gobblerift/break
